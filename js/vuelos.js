...
function definirJornada(horaEvento) {
    ...
    let horaSalida1 = new Date(2022, 03, 12, 6, 12, 0);
    let horaLlegada1 = new Date(2022, 03, 13, 8, 32, 0);
    let horaSalida1Str = definirJornada(horaSalida1);
    let horaLlegada1Str = definirJornada(horaLlegada1);

    let horaSalida2 = new Date(2022, 03, 12, 12, 35, 0);
    let horaLlegada2 = new Date(2022, 03, 13, 1, 45, 0);
    let horaSalida2Str = definirJornada(horaSalida2);
    let horaLlegada2Str = definirJornada(horaLlegada2);

    let horaSalida3 = new Date(2022, 03, 12, 5, 40, 0);
    let horaLlegada3 = new Date(2022, 03, 13, 7, 50, 0);
